...
testthat::test_that("Test S7 functions", {
  a <- rational(5L, 2L, "S7")
  expect_equal(2, floor(a))
  expect_equal(-1, sign(rational(-1L, 2L, "S7")))
  expect_equal(2, round(rational(5L, 2L, "S7"), 0))
  x <- abs(rational(-2L, 3L, "S7"))
  expect_true("rational::rationalS7" %in% class(x))
  expect_true(2/3 == abs(x))
  b <- rational(2L, 5L, "S7")
  expect_equal(log(2/5), log(b))
  expect_equal(log10(2/5), log10(b))
  ...
  expect_equal(log2(2/5), log2(b))
  expect_equal(gamma(2/5), gamma(b))
  expect_equal(gamma(3/2), gamma(rational(3L, 2L, "S7")))
  expect_equal(gamma(-3/2), gamma(rational(-3L, 2L, "S7")))
  expect_true(3 == max(rational(c(2L, 3L), c(5L, 1L), "S7")))
  expect_true(3 == max(rational(2L, 5L, "S7"), rational(3L, 1L, "S7")))
  expect_true(3 == max(rational(c(2L, 3L), c(5L, 1L), "S7"), rational(c(1L,2L), c(6L,7L), "S7")))
  expect_true(2/5 == min(rational(c(2L, 3L), c(5L, 1L), "S7")))
  expect_true(is.list(range(rational(c(2L, 3L), c(5L, 1L), "S7"))))
  expect_true(range(rational(c(2L, 3L), c(5L, 1L), "S7"))[[1]] == rational(2L, 5L, "S7"))
  expect_true(6/5 == prod(rational(c(2L, 3L), c(5L, 1L), "S7")))
  expect_true(17/5 == sum(rational(c(2L, 3L), c(5L, 1L), "S7")))

  expect_warning(.rational_prod(c(.Machine$integer.max, 2L, 3L), c(1L, 1L, 1L)))
  expect_true(prod(rational(1L, 2L, "S7"), rational(1L, 2L, "S7")) == rational(1L, 4L, "S7"))
  expect_warning(.rational_sum(c(.Machine$integer.max, 2L), c(1L, 1L)))
  expect_true(sum(rational(1L, 2L, "S7"), rational(4L, 3L, "S7")) == rational(11L, 6L, "S7"))
})
